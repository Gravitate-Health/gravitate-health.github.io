...
const config = {
  title: 'Gravitate Health | Developer Documentation',
  tagline: 'All you need to know to get started to develop with Gravitate Health',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Gravitate Health Developer Docs',
        logo: {
          alt: 'My Site Logo',
          src: 'img/fosps-logo.png',
        },
        items: [
          {
            type: 'docSidebar',
          ...
          {
            href: 'https://github.com/GravitateHealth/gravitate-health.github.io',
            label: 'GitHub',
            position: 'right',
          },
        ],
